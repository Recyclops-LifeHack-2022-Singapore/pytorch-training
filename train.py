...
def save_model(model_ft, model_name, out_dir):
...
if __name__ == '__main__':
    ...
    data_transforms = {
        'train': transforms.Compose(
            [transforms.RandomResizedCrop(input_size)] if not resize_instead else [transforms.Resize(input_size), transforms.CenterCrop(input_size)] +
    ...
    with open(out_label_map, 'w') as f:
        json.dump(transform_label_map(image_datasets['train'].class_to_idx), f)
    ...
    save_model(model_ft, model_name, out_dir)